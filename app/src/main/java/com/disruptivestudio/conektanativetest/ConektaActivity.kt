...
import com.disruptivestudio.conektanativetest.databinding.ActivityConektaBinding
...
class ConektaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val navController = findNavController(R.id.nav_host_fragment_content_conekta)
